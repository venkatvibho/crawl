...
STATEURL    = "https://affidavit.eci.gov.in/CandidateCustomFilter?electionType=32-AC-GENERAL-3-60&election=32-AC-GENERAL-3-60&states=S25&phase=3&"
BASE_URL    = f"{STATEURL}submitName=100&page={{page}}"
STNAME      = 'WEST BENGAL'
statePhaeid = 3
...
def crawl_with_selenium(start=1, end=3,constId=1,phase=2,headless=True, delay=2.0):
